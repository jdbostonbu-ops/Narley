...
const visibleResources: TestResource[] = [
  { id: "a", address: "1 Main St, New London, CT 06320", latitude: 41.35, longitude: -72.1 },
  { id: "b", address: "2 Oak Ave, New London, CT 06320", latitude: 41.36, longitude: -72.09 },
  { id: "c", address: "3 Elm Rd, New Haven, CT 06515", latitude: 41.31, longitude: -72.93 },
...
describe("resolveMapPins (RMAP-015 map renders all resource pins regardless of card filter)", () => {
