...
const styles = StyleSheet.create({
  ...
  reportReason: { alignItems: 'flex-start', borderColor: theme.colors.border, borderRadius: theme.radius.md, borderWidth: 1, flexDirection: 'row', minHeight: 50, paddingHorizontal: theme.spacing.sm, paddingVertical: theme.spacing.md },
  reportReasonSelected: { backgroundColor: theme.colors.background, borderColor: theme.colors.primary },
  radioOuter: { alignItems: 'center', borderColor: theme.colors.textMuted, borderRadius: 10, borderWidth: 2, height: 20, justifyContent: 'center', marginRight: theme.spacing.sm, marginTop: 1, width: 20 },
  ...
  reportReasonText: { color: theme.colors.text, flex: 1, flexShrink: 1, fontSize: 14, lineHeight: 20, minWidth: 0 },
